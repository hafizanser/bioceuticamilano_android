...
import com.bioceuticamilano.adapters.SavedCardsAdapter
import com.bioceuticamilano.base.ActivityBase
import com.bioceuticamilano.databinding.ActivitySavedCardsBinding
import com.bioceuticamilano.databinding.DefaultItemCardsBinding
            ...
            try {
                ...
                if (!`object`.getBoolean("error")) {
                    ...
                    if (defaultCard != null) {
                        ...
                        val defaultCardBinding = DefaultItemCardsBinding.bind(binding.layoutDefaultCard.rootView)
